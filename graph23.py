...
class AudioStream(object):
    def __init__(self):
        ...
        self.spectrum2 = self.win.addPlot(title='Nitish', row=3, col=1, axisItems={'bottom': sp_xaxis}, )
    ...
    def update(self):
        ...
        sp_data = struct.unpack(str(2 * self.CHUNK) + 'B', wf_data)
        sp_data = np.array(wf_data, dtype='b')[::2] + 128
